...
const adminGroups = [
  {
    ...
    links: [
      ...
      { href: "/gunluk-hedefler", icon: "📅", label: "Günlük Hedefler", description: "Şube günlük hedef ve gerçekleşenlerini yönet" },
    ...
    <nav className="admin-directory" aria-label="Admin yönetim alanları">
      <details className="admin-directory-details" open={isHome}>
        <summary className="admin-directory-summary">
          ...
          <span className="admin-directory-count">22 bölüm</span>
        </summary>
