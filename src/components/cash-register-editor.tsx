...
export function CashRegisterEditor({ row, categories, people, editable }: { row: CashRow; categories: CashCategory[]; people: { id: string; full_name: string; role: string }[]; editable: boolean }) {
